  ...
  return (
    <div className="Body3">
      <div className="body3-container">
        <div className="left-body3">
          <p className="para1-body3">Instant Setup</p>
          <p className="para2-body3">Extremely quick onboarding process</p>
          <p className="para3-body3">
            Onces you've joined, our team of specialist will react out to you
            and get you set up in minutes.
          </p>
          <button className="btn2"> Learn More</button>
        </div>
        <div className="right-body3">
          <svg
            className="svg2"
            ...
            <polygon
              points="249.956 330.343 251.141 330.658 225.287 427.914 75.326 427.914 75.326 426.689 
224.345 426.689 249.956 330.343"
              fill="#2f2e41"
            />
            <path
